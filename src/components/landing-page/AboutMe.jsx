    ...
    <Box align="center" className="py-24 bg-sky-800">
      <Stack className="w-full md:w-3/5">
        ...
        <Text className="font-regular text-lg md:text-xl text-white">
          ...
          <strong>ML Engineer at Simplified</strong> where most of my task is
          currently revolving around playing with Generative Models and helping
          setup deployment pipelines for DL models. I'm a blog writer as well
          and currently building a course on explaining the inner workings of
          PyTorch.
          <br />
          <br />
          In my free time, I do freelancing or write posts on Twitter or
