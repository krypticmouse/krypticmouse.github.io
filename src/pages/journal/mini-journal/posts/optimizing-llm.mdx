...
title: 'Optimizing LLMs'
description: "A thread on all the papers that are trying to optimize LLM training, inference, practices, etc. I'll keep adding more papers as I read them."
date: '2023-05-31'
isPublished: true
---

There is just too much going on in the world of NLP right now, it's hard to keep up with all the new papers and research. But there are some papers that are just too good to miss out on, and I'm gonna talk about all of them in this thread blog or whatever you wanna call it. Will keep adding older ones too!
