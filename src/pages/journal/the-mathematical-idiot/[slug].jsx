...
export default function DynamicPage({ source, frontMatter }) {
  return (
    <>
      ...
      <Header />
      <div className="w-full sm:w-4/5 md:w-3/5 mx-auto p-6 blog text-slate-600 mb-8">
        <h1 className="text-center text-2xl sm:text-3xl md:text-4xl font-extrabold">{frontMatter.title}</h1>
